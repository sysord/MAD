 ...
 *
 */
public interface QueryEvaluationServiceV1 {
	 ...
	 * @return
	 */
	public <T> T evaluateExpression(EObject contextObject, String languageId, String queryExpr, Map<String, Object> arguments) throws QueryEvaluatorException;
	 ...
	 * @return
	 */
	public <T> T evaluate(EObject contextObject, QueryDefinition<T> query, Map<String, Object> arguments) throws QueryEvaluatorException;
	 ...
	 */
	public EvaluationAnalyze evaluateWithAnalyze(EObject contextObject, QueryDefinition<?> query, Map<String, Object> arguments) throws QueryEvaluatorException;
	 ...
	 * @param arguments TODO
	 * @return TODO
	 * @return an EObject or null (depending on the Action implementation)
	 * @throws QueryEvaluatorException
	 */
	public EObject runActionQuery(EObject contextObject, QueryDefinition<?> query, Map<String, Object> arguments) throws QueryEvaluatorException;
