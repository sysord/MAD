 ...
 * <ul>
 *   <li>{@link com.sysord.mad.configuration.madConfigDsl.QueryEvaluatorMdsl#getName <em>Name</em>}</li>
...
public interface QueryEvaluatorMdsl extends MADConfigElement
{
   ...
   * @see #setName(String)
   * @see com.sysord.mad.configuration.madConfigDsl.MadConfigDslPackage#getQueryEvaluatorMdsl_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.sysord.mad.configuration.madConfigDsl.QueryEvaluatorMdsl#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
