...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UI Tab Mdsl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class UITabMdslImpl extends MADConfigElementImpl implements UITabMdsl
{
  ...
  public void setI18NLabel(boolean newI18NLabel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MadConfigDslPackage.UI_TAB_MDSL__I18_NLABEL, oldI18NLabel, i18NLabel));
  }
  ...
  public NotificationChain basicSetLabelFormatExpr(FormatExpr newLabelFormatExpr, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MadConfigDslPackage.UI_TAB_MDSL__LABEL_FORMAT_EXPR, oldLabelFormatExpr, newLabelFormatExpr);
  ...
  public void setLabelFormatExpr(FormatExpr newLabelFormatExpr)
  {
    if (newLabelFormatExpr != labelFormatExpr)
    {
      ...
      if (labelFormatExpr != null)
        msgs = ((InternalEObject)labelFormatExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MadConfigDslPackage.UI_TAB_MDSL__LABEL_FORMAT_EXPR, null, msgs);
      if (newLabelFormatExpr != null)
        msgs = ((InternalEObject)newLabelFormatExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MadConfigDslPackage.UI_TAB_MDSL__LABEL_FORMAT_EXPR, null, msgs);
      msgs = basicSetLabelFormatExpr(newLabelFormatExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MadConfigDslPackage.UI_TAB_MDSL__LABEL_FORMAT_EXPR, newLabelFormatExpr, newLabelFormatExpr));
  }
  ...
  public void setDescription(String newDescription)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MadConfigDslPackage.UI_TAB_MDSL__DESCRIPTION, oldDescription, description));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MadConfigDslPackage.UI_TAB_MDSL__DESCRIPTION:
