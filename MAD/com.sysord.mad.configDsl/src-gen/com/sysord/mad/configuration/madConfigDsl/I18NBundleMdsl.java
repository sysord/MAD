 ...
 * <ul>
 *   <li>{@link com.sysord.mad.configuration.madConfigDsl.I18NBundleMdsl#getName <em>Name</em>}</li>
...
public interface I18NBundleMdsl extends MADConfigElement
{
   ...
   * @see #setName(String)
   * @see com.sysord.mad.configuration.madConfigDsl.MadConfigDslPackage#getI18NBundleMdsl_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.sysord.mad.configuration.madConfigDsl.I18NBundleMdsl#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
