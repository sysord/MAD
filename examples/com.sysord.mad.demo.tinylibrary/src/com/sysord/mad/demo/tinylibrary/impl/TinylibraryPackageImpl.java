 ...
 * @generated
 */
public class TinylibraryPackageImpl extends EPackageImpl implements TinylibraryPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see com.sysord.mad.demo.tinylibrary.TinylibraryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private TinylibraryPackageImpl() {
		super(eNS_URI, TinylibraryFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link TinylibraryPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static TinylibraryPackage init() {
		if (isInited) return (TinylibraryPackage)EPackage.Registry.INSTANCE.getEPackage(TinylibraryPackage.eNS_URI);

		// Obtain or create and register package
		TinylibraryPackageImpl theTinylibraryPackage = (TinylibraryPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TinylibraryPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TinylibraryPackageImpl());
		...
		theTinylibraryPackage.createPackageContents();

		// Initialize created meta-data
		theTinylibraryPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTinylibraryPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(TinylibraryPackage.eNS_URI, theTinylibraryPackage);
		return theTinylibraryPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getBook_Published() {
	 ...
	 * @generated
	 */
	public EAttribute getBook_Damaged() {
	 ...
	 * @generated
	 */
	public TinylibraryFactory getTinylibraryFactory() {
		return (TinylibraryFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(bookEClass, BOOK__PUBLISHED);
		createEAttribute(bookEClass, BOOK__DAMAGED);
	...
	public void initializePackageContents() {
		...
		initEReference(getEmployee_Manager(), this.getEmployee(), this.getEmployee_Managed(), "manager", null, 0, 1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEmployee_Managed(), this.getEmployee(), this.getEmployee_Manager(), "managed", null, 0, -1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bookEClass, Book.class, "Book", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBook_Isbn(), theXMLTypePackage.getString(), "isbn", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBook_Authors(), this.getWriter(), this.getWriter_Books(), "authors", null, 1, -1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getBook_Published(), ecorePackage.getEDate(), "published", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBook_Damaged(), theXMLTypePackage.getBoolean(), "damaged", null, 0, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(bookCategoryEEnum, BookCategory.COMPUTING);
	...
	protected void createEAnnotation0Annotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "EStringToStringMapEntry0", null
		   });	
	}

	/**
	 * Initializes the annotations for <b>EAnnotation1</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createEAnnotation1Annotations() {
		String source = "EAnnotation1";			
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
		   ...
		   new URI[] {
			 URI.createURI(eNS_URI).appendFragment("//Person")
		   });
	}

} //TinylibraryPackageImpl
