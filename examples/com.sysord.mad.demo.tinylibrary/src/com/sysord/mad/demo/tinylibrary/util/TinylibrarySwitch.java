 ...
 */
package com.sysord.mad.demo.tinylibrary.util;
 ...
 * @generated
 */
public class TinylibrarySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static TinylibraryPackage modelPackage;
	 ...
	 * @generated
	 */
	public TinylibrarySwitch() {
		if (modelPackage == null) {
			modelPackage = TinylibraryPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TinylibraryPackage.LIBRARY: {
				Library library = (Library)theEObject;
				T result = caseLibrary(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TinylibraryPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TinylibraryPackage.WRITER: {
			...
			case TinylibraryPackage.EMPLOYEE: {
