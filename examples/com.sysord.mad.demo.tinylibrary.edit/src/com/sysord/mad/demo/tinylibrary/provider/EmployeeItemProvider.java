...
/**
 * This is the item provider adapter for a {@link com.sysord.mad.demo.tinylibrary.Employee} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TinylibraryPackage.Literals.EMPLOYEE__MANAGER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addManagedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Employee_managed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Employee_managed_feature", "_UI_Employee_type"),
				 TinylibraryPackage.Literals.EMPLOYEE__MANAGED,
				 true,
				 false,
				 true,
				 null,
